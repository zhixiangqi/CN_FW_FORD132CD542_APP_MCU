...
#define TDDI_USER_BIN1_ENABLED TDDI_ATTN_ENABLED
#define TDDI_USER_BIN_ENABLED TDDI_ATTN_ENABLED
#define TDDI_ATTN_PORT GPIO_PRT3
#define TDDI_USER_BIN1_PORT TDDI_ATTN_PORT
#define TDDI_USER_BIN_PORT TDDI_ATTN_PORT
#define TDDI_ATTN_PORT_NUM 3U
#define TDDI_USER_BIN1_PORT_NUM TDDI_ATTN_PORT_NUM
#define TDDI_USER_BIN_PORT_NUM TDDI_ATTN_PORT_NUM
#define TDDI_ATTN_PIN 4U
#define TDDI_USER_BIN1_PIN TDDI_ATTN_PIN
#define TDDI_USER_BIN_PIN TDDI_ATTN_PIN
#define TDDI_ATTN_NUM 4U
#define TDDI_USER_BIN1_NUM TDDI_ATTN_NUM
#define TDDI_USER_BIN_NUM TDDI_ATTN_NUM
#define TDDI_ATTN_DRIVEMODE CY_GPIO_DM_PULLUP_IN_OFF
#define TDDI_USER_BIN1_DRIVEMODE TDDI_ATTN_DRIVEMODE
#define TDDI_USER_BIN_DRIVEMODE TDDI_ATTN_DRIVEMODE
#define TDDI_ATTN_INIT_DRIVESTATE 1
#define TDDI_USER_BIN1_INIT_DRIVESTATE TDDI_ATTN_INIT_DRIVESTATE
#define TDDI_USER_BIN_INIT_DRIVESTATE TDDI_ATTN_INIT_DRIVESTATE
...
#define TDDI_USER_BIN1_HSIOM TDDI_ATTN_HSIOM
#define TDDI_USER_BIN_HSIOM TDDI_ATTN_HSIOM
#define TDDI_ATTN_IRQ ioss_interrupts_gpio_3_IRQn
#define TDDI_USER_BIN1_IRQ TDDI_ATTN_IRQ
#define TDDI_USER_BIN_IRQ TDDI_ATTN_IRQ

#if defined (CY_USING_HAL)
#define TDDI_ATTN_HAL_PORT_PIN P3_4
#define TDDI_USER_BIN1_HAL_PORT_PIN TDDI_ATTN_HAL_PORT_PIN
#define TDDI_USER_BIN_HAL_PORT_PIN TDDI_ATTN_HAL_PORT_PIN
#define TDDI_ATTN P3_4
#define TDDI_USER_BIN1 TDDI_ATTN
#define TDDI_USER_BIN TDDI_ATTN
#define TDDI_ATTN_HAL_IRQ CYHAL_GPIO_IRQ_FALL
#define TDDI_USER_BIN1_HAL_IRQ TDDI_ATTN_HAL_IRQ
#define TDDI_USER_BIN_HAL_IRQ TDDI_ATTN_HAL_IRQ
#define TDDI_ATTN_HAL_DIR CYHAL_GPIO_DIR_OUTPUT 
#define TDDI_USER_BIN1_HAL_DIR TDDI_ATTN_HAL_DIR
#define TDDI_USER_BIN_HAL_DIR TDDI_ATTN_HAL_DIR
#define TDDI_ATTN_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_PULLUP
#define TDDI_USER_BIN1_HAL_DRIVEMODE TDDI_ATTN_HAL_DRIVEMODE
#define TDDI_USER_BIN_HAL_DRIVEMODE TDDI_ATTN_HAL_DRIVEMODE
#endif /* defined (CY_USING_HAL) */
...
#define TDDI_USER_BIN1_config TDDI_ATTN_config
#define TDDI_USER_BIN_config TDDI_ATTN_config

#if defined (CY_USING_HAL)
extern const cyhal_resource_inst_t TDDI_ATTN_obj;
#define TDDI_USER_BIN1_obj TDDI_ATTN_obj
#define TDDI_USER_BIN_obj TDDI_ATTN_obj
#endif /* defined (CY_USING_HAL) */
